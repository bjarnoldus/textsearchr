...
@objc class SQLColumn {
    ...
    func asDate()->NSDate? {
        ...
        case SQLITE_INTEGER, SQLITE_FLOAT:
            ...
            return NSDate(timeIntervalSinceReferenceDate: tm)
...
//BJA DB naam is niet configureerbaar
@objc class SQLiteDB {
    ...
    class func sharedInstance(dbName:String) -> SQLiteDB! {
        dispatch_once(&Static.token) {
            println("SQLiteDB - Dispatch once")
            Static.instance = self(dbName: dbName)
        }
